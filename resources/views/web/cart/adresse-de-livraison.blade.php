                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="pays_id" class="custom-select" id="state" required>
                        ...
                        {{-- <div class="col-sm-4" id="laVille">
                            <div class="form-group">
                                <label for="address-country">
                                    Ville <span class="text-danger">*</span>
                                </label>
                                <select name="ville" class="custom-select" id="ville" required>
                                    <option value="">-------</option>
                        ...
                        {{-- <div class="col-sm-4" id="leQuartier" style="display: none;">
                            <div class="form-group">
                                <label for="address-country">
                                    Quartier <span class="text-danger">*</span>
                                </label>
                                <select name="quartier" class="custom-select" id="quartier" required></select>
                            </div>
                        </div> --}}
                        <div class="col-sm-6">
                            <div class="form-group">
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        if(data){
                            ...
                            $('#ville').empty();
                            $('#ville').focus;
                            $('#ville').append('<option value="">-- Choisir Ville --</option>');
                            $.each(data, function(key, value){
                                incrementation++;
                                $('select[name="ville"]').append('<option value="'+ value.id +'">' + value.libelle+ '</option>');
                            });
                            if(incrementation == 0){
                                $('#laVille').hide();
                            }
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        if(data){
                            ...
                            $('#quartier').empty();
                            $('#quartier').focus;
                            $('#quartier').append('<option value="">-- Choisir le quartier --</option>');
                            $.each(data, function(key, value){
                                incrementation++;
                                $('select[name="quartier"]').append('<option value="'+ value.id +'">' + value.libelle+ '</option>');
                            });
                            if(incrementation == 0){
                                $('#leQuartier').hide();
                            }
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        incrementation = 0;
                            ...
                            $('#marque').empty();
                            $('#marque').focus;
                            $('#marque').append('<option value="">-- Choisir la marque --</option>');
                            $.each(data, function(key, value){
                                incrementation++;
                                $('select[name="marque"]').append('<option value="'+ value.id +'">' + value.libelle+ '</option>');
                            });
                            if(incrementation == 0){
                                $('#laMarque').hide();
                                $('#vehicule').hide();
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        if(data){
                            ...
                            $('#modele').empty();
                            $('#modele').focus;
                            $('#modele').append('<option value="">-- Choisir le modèle --</option>');
                            $.each(data, function(key, value){
                                incrementation++;
                                $('select[name="modele"]').append('<option value="'+ value.id +'">' + value.libelle+ '</option>');
                            });
                            if(incrementation == 0){
                                $('#leModele').hide();
                            }
